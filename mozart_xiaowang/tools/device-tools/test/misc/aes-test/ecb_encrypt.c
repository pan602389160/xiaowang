...
//	unsigned int iv[4] = {0x7f444fd5,0xd2002d29,0x4b96c34d,0xc57d297e};
	unsigned int input[4] = {0x69cfa45b, 0x18a1eb8d, 0x6c62fba9, 0xda051983};
	unsigned int output[4] = {0};
	unsigned int expect[4] = {0x661b2c7a, 0x4c6b5ec2, 0xd58882bc, 0xd51cd190};
...
//	aes_key.ivlen = 16;
	...
	for(i = 0; i < aes_data.input_len / 4; i++) {
		printf("encrypt-output[%d]: %x ,expect[%d]: %x \n", i, output[i], i, expect[i]);
	}
