...
define hostapd-realtek_INSTALL_TARGET_CMDS
	mkdir -p $(MOZART_APP_DIR)/usr/sbin; \
...
-rm -f $(MOZART_APP_DIR)/usr/sbin/{hostapd_realtek,hostapd_cli_realtek}
endef
define hostapd-broadcom_UNINSTALL_TARGET_CMDS
-rm -f $(MOZART_APP_DIR)/usr/sbin/{hostapd_broadcom,hostapd_cli_broadcom}
endef

TARGETS += hostapd
ifeq ("$(call substring,$(SUPPORT_WIFI_MODULE),1,3)", "ssv") # realtek's wifi module.
